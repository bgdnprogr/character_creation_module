...
def attack(char_name: str, char_class: str) -> str:
    """Возвращает строку с нанесённым уроном."""
...
def special(char_name: str, char_class: str) -> str:
    """Возвращает строку с применением специального умения"""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Характиризует выбранного персонажа и проводит с ним тренировку."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    ...
    return char_class  # type: ignore[return-value]
